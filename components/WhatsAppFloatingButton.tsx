...
export default function WhatsAppFloatingButton() {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3">
      {/* Small Tooltip Bubble (visible on hover/focus or touch toggle) */}
      <div
      ...
      <a
        ...
        className="relative group flex items-center justify-center w-14 h-14 bg-emerald-whatsapp text-white rounded-full whatsapp-glow hover:scale-105 active:scale-95 transition-all duration-300 shadow-2xl"
      >
